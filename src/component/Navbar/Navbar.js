            ...
            <Sticky top={0} innerZ={9999} activeClass="navbar_fixed">
                <nav className={`navbar navbar-expand-lg navbar-light ${mClass}`}>
                    <div className={`container ${mContainer}`}>
                        <a className="navbar-brand logo_h initial" href="index.html"  style={{width: '60px', backgroundImage: `url(${bg})`}}>
                        ...
                        <a className="navbar-brand logo_h reverse" href="index.html"  style={{width: '60px', backgroundImage: `url(${bgReverse})`}}>
                            {/*<img src={require ("../../image/" + mainlogo)} alt=""/>*/}
                            {/*<img src={require ("../../image/" + stickylogo)} alt=""/>*/}
                            <span className="navbar-brand-first-letter">T</span>
                            <span className="navbar-brand-second-letter">W</span>
